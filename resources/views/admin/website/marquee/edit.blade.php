...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title">Edit Marquee Item</h1></div>
...
<form action="{{ route('admin.website.marquee.update', $item->id) }}" method="POST">
@csrf @method('PUT')
    ...
    <div class="panel-card-body">
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="text_en" value="{{ old('text_en', $item->text_en) }}" class="form-control @error('text_en') is-invalid @enderror" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="text_ar" value="{{ old('text_ar', $item->text_ar) }}" class="form-control @error('text_ar') is-invalid @enderror" dir="rtl" required>
