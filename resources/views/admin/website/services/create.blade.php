...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title">Add Service</h1></div>
...
<form action="{{ route('admin.website.services.store') }}" method="POST">
@csrf
    ...
    <div class="panel-card-body">
        <div class="row g-3">
            <div class="col-md-2">
                ...
                <input type="text" name="number" value="{{ old('number', '01') }}" class="form-control" required>
            </div>
            <div class="col-md-2">
                <label class="form-label">Letter</label>
                <input type="text" name="letter" value="{{ old('letter') }}" class="form-control" maxlength="5">
            </div>
            <div class="col-md-4">
