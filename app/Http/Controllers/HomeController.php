...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $aboutStats    = AboutStat::orderBy('sort_order')->get();
        $servicesHeader = SectionHeader::forSection('services');
        $services      = Service::active()->get();
        $processHeader = SectionHeader::forSection('process');
        $processSteps  = ProcessStep::ordered()->get();
        $trustItems    = TrustItem::active()->get();
        $teamHeader    = SectionHeader::forSection('team');
        $teamMembers   = TeamMember::active()->get();
        $contactHeader = SectionHeader::forSection('contact');
        $contactPhones = ContactPhone::active()->get();
        ...
        return view('front.home', compact(
            ...
            'processHeader', 'processSteps',
            'trustItems',
            'teamHeader', 'teamMembers',
            'contactHeader', 'contactPhones', 'location',
            'whatsapp'
        ));
    }
