...
<head>
    ...
    <title><?php echo e(__('messages.admin_login_title')); ?> — Lotus</title>
...
<div class="l-panel">
    ...
    <div class="l-brand">
        ...
        <div class="l-brand-name">Al<span>Lotus</span></div>
    </div>
...
<div class="r-panel">
    <div class="r-wrap">
        ...
        <div class="r-lang">
            <a class="lang-switch" href="<?php echo e(LaravelLocalization::getLocalizedURL($otherLocale, null, [], true)); ?>">
                <i class="bi bi-translate"></i> <?php echo e(__('messages.switch_language')); ?>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        required
                    >
                    <button type="button" class="pw-toggle" id="pwToggle" aria-label="<?php echo e(__('messages.toggle_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="r-footer">
            &copy; <?php echo e(date('Y')); ?> Lotus. <?php echo e(__('messages.all_rights_reserved')); ?>
...
<?php /**PATH C:\xampp\htdocs\lotus\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>